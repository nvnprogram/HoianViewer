...
namespace GLFrameworkEngine
{
    public class Camera
    {
        ...
        /// <summary>
        /// Forces explicit view/projection matrices (e.g. a light view for shadow
        /// rendering). Call UpdateMatrices() afterwards to restore normal behavior.
        /// </summary>
        public void SetCustomMatrices(Matrix4 view, Matrix4 projection)
        {
            viewMatrix = view;
