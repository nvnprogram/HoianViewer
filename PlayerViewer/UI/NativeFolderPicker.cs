...
namespace PlayerViewer.UI
{
    ...
    static class NativeFolderPicker
    {
        public static string SelectFolder(string title, string startPath = null)
        {
            try
            {
                return OperatingSystem.IsWindows()
                    ? SelectFolderCom(title, startPath)
                    : SelectFolderTfd(title, startPath);
            }
            catch
            {
                return null;
        ...
        public static string OpenFile(string title, string filterDisplay, string filterExt)
        {
            ...
            {
                return OperatingSystem.IsWindows()
                    ? OpenFileCom(title, filterDisplay, filterExt)
                    : OpenFileTfd(title, filterDisplay, filterExt);
            }
            catch
            {
                return null;
        ...
        )
        {
            ...
            {
                return OperatingSystem.IsWindows()
                    ? SaveFileCom(title, defaultName, filterDisplay, filterExt)
                    : SaveFileTfd(title, defaultName, filterDisplay, filterExt);
            }
            catch
            {
                return null;
        ...
        )
        {
            ...
            try
            {
                ...
                SetOptions(
                    dlg,
                    opts
                        | 0x2 /* FOS_OVERWRITEPROMPT */
                        | 0x40 /* FOS_FORCEFILESYSTEM */
                );
        ...
        static int Show(IntPtr dlg, IntPtr hwnd) =>
            Marshal.GetDelegateForFunctionPointer<ShowDelegate>(Vtbl(dlg, 3))(dlg, hwnd);

        static void SetOptions(IntPtr dlg, uint opts) =>
            Marshal.GetDelegateForFunctionPointer<SetOptionsDelegate>(Vtbl(dlg, 9))(dlg, opts);

        static void GetOptions(IntPtr dlg, out uint opts)
        {
            opts = 0;
            Marshal.GetDelegateForFunctionPointer<GetOptionsDelegate>(Vtbl(dlg, 10))(dlg, out opts);
        }

        static void SetFileTypes(IntPtr dlg, uint count, ref COMDLG_FILTERSPEC filters) =>
            Marshal.GetDelegateForFunctionPointer<SetFileTypesDelegate>(Vtbl(dlg, 4))(
                dlg,
                count,
                ref filters
            );

        static void SetFileName(IntPtr dlg, string name) =>
            Marshal.GetDelegateForFunctionPointer<SetFileNameDelegate>(Vtbl(dlg, 15))(dlg, name);

        static void SetFolder(IntPtr dlg, IntPtr folder) =>
            Marshal.GetDelegateForFunctionPointer<SetFolderDelegate>(Vtbl(dlg, 12))(dlg, folder);

        static void SetTitle(IntPtr dlg, string title) =>
            Marshal.GetDelegateForFunctionPointer<SetTitleDelegate>(Vtbl(dlg, 17))(dlg, title);

        static int GetResult(IntPtr dlg, out IntPtr item) =>
            Marshal.GetDelegateForFunctionPointer<GetResultDelegate>(Vtbl(dlg, 20))(dlg, out item);

        static int GetDisplayName(IntPtr item, uint sigdn, out IntPtr name) =>
            Marshal.GetDelegateForFunctionPointer<GetDisplayNameDelegate>(Vtbl(item, 5))(
                item,
                sigdn,
                out name
            );
        ...
        delegate int ShowDelegate(IntPtr self, IntPtr hwnd);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        delegate int SetOptionsDelegate(IntPtr self, uint opts);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        delegate int GetOptionsDelegate(IntPtr self, out uint opts);

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        delegate int SetFileTypesDelegate(IntPtr self, uint count, ref COMDLG_FILTERSPEC filters);

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        delegate int SetFileNameDelegate(IntPtr self, string name);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        delegate int SetFolderDelegate(IntPtr self, IntPtr folder);

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode)]
        delegate int SetTitleDelegate(IntPtr self, string title);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        delegate int GetResultDelegate(IntPtr self, out IntPtr item);

        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        delegate int GetDisplayNameDelegate(IntPtr self, uint sigdn, out IntPtr name);
        ...
        static string WithPatterns(string filterExt, Func<int, IntPtr[], IntPtr> call)
        {
            ...
            try
            {
                return Str(call(utf8.Length, utf8));
            }
            finally
            {
                foreach (var p in utf8)
